...
For more details on using HTTP2 check out the Fastify [HTTP2](./HTTP2)
documentation page.
...
serializers as well, see the [Logging](./Logging) documentation for more info.
...
[`fastify.register()`](./Server#register) method. The type interface returns
...
use it following the general [logger](./Logging) documentation.
