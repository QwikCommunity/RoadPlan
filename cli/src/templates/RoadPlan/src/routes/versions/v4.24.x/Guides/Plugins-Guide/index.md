...
[`decorate`](../Reference/Decorators/) API:
...
executed whenever the server "[emits](../Reference/Lifecycle/)" an
event?
...
An alternative approach is to make use of the [onRoute hook](../Reference/Hooks/#onroute)
...
based on a [route config option](../Reference/Routes/#routes-options):
...
to the external Fastify instance via [`decorate`](../Reference/Decorators/),
