...
- `query` - the parsed querystring, its format is specified by
  [`querystringParser`](./Server#querystringparser)
- `body` - the request payload, see [Content-Type
  Parser](./ContentTypeParser) for details on what request payloads Fastify
...
- `ips` - an array of the IP addresses, ordered from closest to furthest, in the
  ...
  [`trustProxy`](./Server/#factory-trust-proxy) option is enabled)
- `hostname` - the host of the incoming request (derived from `X-Forwarded-Host`
  header when the [`trustProxy`](./Server/#factory-trust-proxy) option is
...
- `context` - Deprecated, use `request.routeOptions.config` instead.
  ...
  - `context.config` - The route [`config`](./Routes/#routes-config) object.
...
- `routeConfig` - Deprecated, use `request.routeOptions.config` instead. The
  route [`config`](./Routes/#routes-config)
  object.
- `routeOptions` - The route [`option`](./Routes/#routes-options) object
  - `bodyLimit` - either server limit or route limit
  - `config` - the [`config`](./Routes/#routes-config) object for this route
...
by using the provided [`SchemaControler#ValidationCompiler`](./Server/#schema-controller).
