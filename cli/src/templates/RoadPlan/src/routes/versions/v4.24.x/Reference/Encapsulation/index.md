...
encapsulation context governs which [decorators](./Decorators), registered
[hooks](./Hooks), and [plugins](./Plugins) are available to
[routes](./Routes). A visual representation of the encapsulation context
...
Given that everything in Fastify is a [plugin](./Plugins), except for the
