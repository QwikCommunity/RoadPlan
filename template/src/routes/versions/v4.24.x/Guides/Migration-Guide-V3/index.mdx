...
The logging [Serializers](../Reference/Logging/) have been updated to now
Fastify [`Request`](../Reference/Request/) and
[`Reply`](../Reference/Reply/) objects instead of native ones.
...
- Deprecated `request.req` and `reply.res` for
  [`request.raw`](../Reference/Request/) and
  [`reply.raw`](../Reference/Reply/)
...
- Added [`connectionTimeout`](../Reference/Server/#factory-connection-timeout)
  option ([#2086](https://github.com/fastify/fastify/pull/2086))
- Added [`keepAliveTimeout`](../Reference/Server/#factory-keep-alive-timeout)
  option ([#2086](https://github.com/fastify/fastify/pull/2086))
- Added async-await support for [plugins](../Reference/Plugins/#async-await)
