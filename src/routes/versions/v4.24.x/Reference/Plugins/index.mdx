...
be a set of routes, a server [decorator](./Decorators), or whatever. The API
...
Started](../Guides/Getting-Started/#your-first-plugin) guide how easy it is
to use this API:
...
- [`logLevel`](./Routes/#custom-log-level)
- [`logSerializers`](./Routes/#custom-log-serializer)
...
variables injected via [`decorate`](./Decorators) by preceding plugins
...
happen, you can use the [`'onClose'`](./Hooks/#on-close) hook.
...
with [`decorate`](./Decorators), it is your responsibility to tell Fastify
