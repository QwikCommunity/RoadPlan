...
declaration](../Reference/Routes/) docs).
...
[here](../Reference/Plugins/#handle-the-scope) to understand how to handle the
scope of a plugin)_.
...
Read [Validation and
Serialization](../Reference/Validation-and-Serialization/) to learn more.
...
[Validation and Serialization](../Reference/Validation-and-Serialization/) to
learn more.
...
request](../Reference/Request/) object at `request.body`.
...
Read [Content-Type Parser](../Reference/ContentTypeParser/) to learn more
...
an amazing [ecosystem](./Ecosystem)!
...
Read the [testing](./Testing) documentation to learn more!
